...
function Features() {
  return (    <section id="features" className="relative py-12">
      ...
      <div className="max-w-screen-xl mx-auto px-4 lg:px-6">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="md:w-2/5 lg:w-1/3 mb-6 md:mb-0">
            <Card className="border-1 border-default-200 dark:border-default-100/20 p-2 shadow-lg">
              <Image
                isZoomed
                isBlurred
          ...
          <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <Card key={index} className="border-1 border-default-200 dark:border-default-100/20 shadow-md">
